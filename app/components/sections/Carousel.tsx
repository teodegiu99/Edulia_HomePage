  ...
  return (
    ...
    >
      <div className="relative overflow-hidden p-4">
        <button
          className={`rounded-lg border-[1px] border-neutral-400 bg-white p-1.5 text-2xl transition-opacity absolute left-4 top-[220px] z-50 ${
        ...
        <button
          className={`rounded-lg border-[1px] border-neutral-400 bg-white p-1.5 text-2xl transition-opacity absolute right-4 top-[220px] z-50 ${
        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex lg:flex-row flex-col lg:items-center justify-between mb-8">
            ...
            <div className="flex items-center ">
              <p className="lg:text-lg text-[14px] text-[#f8485e] font-semibold">
                Scoprili tutti &gt;
              </p>
            </div>
          </div>
